...
const WhyUs: React.FC = () => {
  return (
    <section id="why-us" className="w-full px-4 sm:px-8 md:px-12 lg:px-16 py-20 bg-black">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white text-opacity-60">{row.you}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-white text-opacity-60">Fancy Agencies:</span>
                    <div className="flex items-center gap-2">
                      <X className="w-5 h-5 text-red-400" />
                      <span className="text-white text-opacity-60">{row.others}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
